...
import { GET_TRANSACTION_STATISTICS } from "../src/graphql/queries/transaction.query";
			...
			<div className='flex flex-col gap-6 items-center max-w-7xl mx-auto z-20 relative justify-center'>
				<div className='flex items-center'>
					...
					<img
						...
						alt='Avatar'
					/>
					{!loading && <MdLogout className='mx-2 w-5 h-5 cursor-pointer text-white hover:text-gray-200'  onClick={handleLogout} />}
					{/* loading spinner */}
